...
interface WidgetProps {
  ...
  houseShape: HouseShape; bubbleStyle: BubbleStyle; accent: string
}

export function Widget({ simSec, schedule, character, houseShape, bubbleStyle, accent }: WidgetProps) {
  ...
  const HOUSE_SCALE = 3.5, FAIRY_SCALE = 2.3

  return (
    <div
      onMouseDown={handleMouseDown}
      style={{ position: 'relative', width: 185, height: 200, cursor: 'grab', userSelect: 'none' }}>
